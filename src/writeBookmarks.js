...
const writeBookmarks = (dataArr, bookmarkFilePath) =>
	new Promise((resolve, reject) => {
		...
		const writableStream = fs.createWriteStream(bookmarkFilePath, { flags: "w+" });
		...
		writableStream.on("finish", () => {
			console.log(`All your bookmarks have been written to ${bookmarkFilePath}`);
			resolve();
		});
	});
